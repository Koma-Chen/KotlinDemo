package koma.mvvm.ext

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.viewModelScope
import kotlinx.coroutines.*
import koma.mvvm.base.activity.BaseVmActivity
import koma.mvvm.base.fragment.BaseVmFragment
import koma.mvvm.base.viewmodel.BaseViewModel
import koma.mvvm.ext.util.loge
import koma.mvvm.network.AppException
import koma.mvvm.network.BaseResponse
import koma.mvvm.network.ExceptionHandle
import koma.mvvm.state.ResultState
import koma.mvvm.state.paresException
import koma.mvvm.state.paresResult
...
fun <T> BaseViewModel.request(
    ...
    return viewModelScope.launch {
        runCatching {
            ...
            LogUtils.debugInfo("网络失败:${it.message}")
            //网络请求异常 关闭弹窗
            loadingChange.dismissDialog.postValue(false)
            //打印错误消息
            //失败回调
