...
import com.example.kotlindemo.app.network.interceptor.MyHeadInterceptor
import com.example.kotlindemo.app.network.interceptor.RestfulInterceptor
...
class NetworkApi : BaseNetworkApi() {
    ...
    override fun setHttpClientBuilder(builder: OkHttpClient.Builder): OkHttpClient.Builder {
        builder.apply {
            ...
            addInterceptor(RestfulInterceptor())
